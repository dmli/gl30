...
public abstract class YCNode {
    ...
    public static final String DEFAULT_VERTEX_SHADER = "" +
            ...
            "vTextureCoordinate = uFlipScale * (aPosition / 2.0 * uRotation) + 0.5;" +
            "}";
    ...
    private void bindShader() {
        ...
        Log.e("bindShader", "uRotation = "+ uRotation);
        uFlipScale = GLES20.glGetUniformLocation(mProgram.getProgramId(), "uFlipScale");
        Log.e("bindShader", "uFlipScale = "+ uFlipScale);
    ...
    protected int createDefaultVertexBuffer() {
        return YCUtils.glGenBuffers(GLES20.GL_ARRAY_BUFFER, defaultVertexArray);
    }
    ...
    protected int createDefaultTextureBuffer() {
        return YCUtils.glGenBuffers(GLES20.GL_ARRAY_BUFFER, defaultTextureArray);
    }
